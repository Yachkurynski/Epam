...
/**
 * Describes black checker figure.
 */
public class BlackChecker extends CheckersFigure {
  /**
   * Creates instance of black checker.
   ...
   */
  public BlackChecker(Coordinate departureCoordinate, Coordinate destinationCoordinate)
